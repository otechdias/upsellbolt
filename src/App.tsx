...
import favicon from "./assets/favicon.ico"; // ou .ico
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900 to-black text-white">
      {/* Fixed Header */}
      <div className="fixed top-0 left-0 right-0 bg-purple-800 border-b border-purple-800 z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <p className="text-white-400 font-semibold hidden md:block uppercase">
                Se você fechar essa página nunca mais você vai ver essa oferta
              </p>
            </div>
            <div className="bg-purple-500 text-white px-4 py-2 rounded-lg shadow-[0_0_20px_rgba(147,51,234,0.5)]">
      ...
      <div className="pt-16">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
            ...
            <div className="w-full text-center">
              ...
              <div
                ...
                className="bg-yellow-400 text-black px-8 py-4 rounded-full font-bold text-xl hover:bg-yellow-300 transition cursor-pointer inline-flex items-center gap-2 shadow-[0_0_30px_rgba(250,204,21,0.4)] hover:shadow-[0_0_30px_rgba(250,204,21,0.6)]"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-purple-800/30 p-8 rounded-xl backdrop-blur">
              <Code2 className="w-12 h-12 mb-4 text-purple-400" />
              <h3 className="text-xl font-bold mb-2">HTML, CSS e JavaScript</h3>
            ...
            <div className="bg-purple-800/30 p-8 rounded-xl backdrop-blur">
              <Figma className="w-12 h-12 mb-4 text-purple-400" />
            ...
            <div className="bg-purple-800/30 p-8 rounded-xl backdrop-blur">
              <Layout className="w-12 h-12 mb-4 text-purple-400" />
              <h3 className="text-xl font-bold mb-2">Python, Java e React</h3>
              <p className="text-purple-200">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-3 bg-purple-800/20 p-4 rounded-lg"
                >
              ...
              >
                {[...testimonials, ...testimonials].map(
                  (testimonial, index) => (
                    ...
                    >
                      <div className="bg-purple-800/30 rounded-xl overflow-hidden backdrop-blur">
                        <img
          ...
          {/* CTA Section */}
          <div className="text-center bg-purple-800/30 p-12 rounded-2xl backdrop-blur">
          ...
          <div className="mt-16 max-w-4xl mx-auto px-4">
            ...
            <div className="space-y-6">
              <div className="bg-purple-800/30 p-6 rounded-xl backdrop-blur">
      ...
      {/* Footer */}
      <footer className="border-t border-purple-800/30 mt-16">
        <div className="container mx-auto px-4 py-8 text-center text-purple-400">
      ...
      <Link
        to="/light"
        className="fixed bottom-4 right-4 bg-white text-gray-800 px-4 py-2 rounded-full shadow-lg hover:shadow-xl transition"
      >
        Versão Clara
      </Link>
    </div>
